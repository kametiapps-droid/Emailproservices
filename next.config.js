    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src * 'unsafe-inline' 'unsafe-eval' data: blob:; script-src * 'unsafe-inline' 'unsafe-eval'; style-src * 'unsafe-inline'; img-src * data: blob:; font-src * data:; connect-src *; frame-src *; frame-ancestors 'self' https://*.vercel.app https://*.replit.dev https://*.replit.app https://*.repl.co https://*.mytempmail.pro" },
        ],
      },
      {
        source: '/favicon.png',
